...
function getMousePosition(e, smooth = false) {
    ...
    const prevX = mousePositionIncrease.x;
    const prevY = mousePositionIncrease.y;
...
function main() {
    ...
    mousepad.addEventListener("mousedown", (e) => {
        ...
        mousepad.addEventListener("mousemove", getMousePosition);
    });
    ...
    mousepad.addEventListener("touchstart", (e) => {
        ...
        mousepad.addEventListener("touchmove", getMousePosition);
    });
    ...
    mousepad.addEventListener("click", (e) => { getMousePosition(e, true); });
